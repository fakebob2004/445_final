...
hardware can command a quadrotor through takeoff, translation, and landing using the wristband
voice path (following conventional transmitter checkout flights).
The ESP32 and VC-02 combination met the wristband command-latency budget, and the ELRS link
delivered CRSF frames at the firmware's 50~Hz cadence.
On the aircraft, early Betaflight builds were used for telemetry experiments; the final autonomy
stack relied on ArduPilot AltHold for closed-loop altitude, reducing dependence on downlink
telemetry for hover regulation.
